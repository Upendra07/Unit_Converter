...
class LengthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Convert Length"
    }
    ...
    override fun onCreateView(
        ...
        val speedUnits = resources.getStringArray(R.array.length_units)
    ...
    private fun calculateResult(from: String, to: String, value: String){
        ...
        when(from+to){
            ...
            resources.getStringArray(R.array.length_units)[0]+resources.getStringArray(R.array.length_units)[1] ->{
                resultValue = givenValue/10f
            }
            resources.getStringArray(R.array.length_units)[0]+resources.getStringArray(R.array.length_units)[2]->{
                resultValue = givenValue / 25.4f
            }
            resources.getStringArray(R.array.length_units)[0]+resources.getStringArray(R.array.length_units)[3]->{
                resultValue = givenValue / 1000f

            }
            resources.getStringArray(R.array.length_units)[0]+resources.getStringArray(R.array.length_units)[4]->{
                resultValue = givenValue / (2.71f+6f)
            }


            resources.getStringArray(R.array.length_units)[1]+resources.getStringArray(R.array.length_units)[0]->{
                resultValue = givenValue * 10f
            }
            resources.getStringArray(R.array.length_units)[1]+resources.getStringArray(R.array.length_units)[2]->{
                resultValue = givenValue / 2.54f
            }
            resources.getStringArray(R.array.length_units)[1]+resources.getStringArray(R.array.length_units)[3] ->{
                resultValue = givenValue / 100f
            }
            resources.getStringArray(R.array.length_units)[1]+resources.getStringArray(R.array.length_units)[4]->{
                resultValue = givenValue / 100000f
            }


            resources.getStringArray(R.array.length_units)[2]+resources.getStringArray(R.array.length_units)[0]->{
                resultValue = givenValue * 25.4f
            }
            resources.getStringArray(R.array.length_units)[2]+resources.getStringArray(R.array.length_units)[1]->{
                resultValue = givenValue * 2.54f
            }
            resources.getStringArray(R.array.length_units)[2]+resources.getStringArray(R.array.length_units)[3]->{
                resultValue = givenValue / 39.37f
            }
            resources.getStringArray(R.array.length_units)[2]+resources.getStringArray(R.array.length_units)[4]->{
                resultValue = givenValue / 39370f
            }


            resources.getStringArray(R.array.length_units)[3]+resources.getStringArray(R.array.length_units)[0]->{
                resultValue = givenValue * 1000f
            }
            resources.getStringArray(R.array.length_units)[3]+resources.getStringArray(R.array.length_units)[1]->{
                resultValue = givenValue* 100f
            }
            resources.getStringArray(R.array.length_units)[3]+resources.getStringArray(R.array.length_units)[2]->{
                resultValue = givenValue * 39.37f
            }
            resources.getStringArray(R.array.length_units)[3]+resources.getStringArray(R.array.length_units)[4]->{
                resultValue = givenValue / 1000f
            }



            resources.getStringArray(R.array.length_units)[4]+resources.getStringArray(R.array.length_units)[0]->{
                resultValue = givenValue * (2.71f+6f)
            }
            resources.getStringArray(R.array.length_units)[4]+resources.getStringArray(R.array.length_units)[1]->{
                resultValue = givenValue * 100000f
            }
            resources.getStringArray(R.array.length_units)[4]+resources.getStringArray(R.array.length_units)[2]->{
                resultValue = givenValue * 39370f;
            }
            resources.getStringArray(R.array.length_units)[4]+resources.getStringArray(R.array.length_units)[3]->{
                resultValue = givenValue * 1000f
            }
        }
