...
class TimeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Convert Time"
    }
    ...
    private fun calculateResult(from: String, to: String, value: String){
        ...
        when(from+to){
            resources.getStringArray(R.array.time_units)[0]+resources.getStringArray(R.array.time_units)[1]->{
                resultValue = givenValue / 60f
            }
            resources.getStringArray(R.array.time_units)[0]+resources.getStringArray(R.array.time_units)[2]->{
                resultValue = givenValue / 3600f
            }
            resources.getStringArray(R.array.time_units)[0]+resources.getStringArray(R.array.time_units)[2]->{
               resultValue = givenValue / 86400f
            }

            resources.getStringArray(R.array.time_units)[1]+resources.getStringArray(R.array.time_units)[0]->{
                resultValue = givenValue * 60f
            }
            resources.getStringArray(R.array.time_units)[1]+resources.getStringArray(R.array.time_units)[2]->{
                resultValue = givenValue / 60f
            }
            resources.getStringArray(R.array.time_units)[1]+resources.getStringArray(R.array.time_units)[3]->{
                resultValue = givenValue / 1440f
            }

            resources.getStringArray(R.array.time_units)[2]+resources.getStringArray(R.array.time_units)[0]->{
                resultValue = givenValue * 3600f
            }
            resources.getStringArray(R.array.time_units)[2]+resources.getStringArray(R.array.time_units)[1]->{
                resultValue = givenValue * 60f
            }
            resources.getStringArray(R.array.time_units)[2]+resources.getStringArray(R.array.time_units)[3]->{
                resultValue = givenValue / 24f
            }

            resources.getStringArray(R.array.time_units)[3]+resources.getStringArray(R.array.time_units)[0]->{
                resultValue = givenValue * 86400f
            }
            resources.getStringArray(R.array.time_units)[3]+resources.getStringArray(R.array.time_units)[1]->{
                resultValue = givenValue * 1440f
            }
            resources.getStringArray(R.array.time_units)[3]+resources.getStringArray(R.array.time_units)[2]->{
                resultValue = givenValue * 24f
            }
        }
